...
const SCREENS = new Set(["feed", "watch", "library", "liked", "downloads", "connectors", "convert", "history", "videos", "search", "recommendations", "settings"]);
const LABELS = { feed: "Swipe feed", watch: "Watch", library: "My library", liked: "Liked videos", downloads: "Downloads", connectors: "Connectors", convert: "Convert media", history: "Conversion history", videos: "Converted videos", search: "Search videos", recommendations: "Recommendations", settings: "Settings" };
function screenFromHash() {
  ...
  return { screen: SCREENS.has(name) ? name : "library", id: id || null, query: (params.get("q") || "").trim().slice(0, 200), source: ["youtube", "rumble"].includes(source) ? source : "all" };
}
